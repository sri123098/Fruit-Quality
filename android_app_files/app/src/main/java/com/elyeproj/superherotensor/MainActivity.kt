...
class MainActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val MODEL_FILE = "file:///android_asset/fruits_stripped_graph.pb"
        private const val LABEL_FILE = "file:///android_asset/fruits_labels.txt"
    }
        ...
        runOnUiThread {
            ...
            if (results.isEmpty()) {
                ...
                textResult.text = when {
                    confidence > 0.95 -> getString(R.string.result_confident_hero_found, hero, "%.2f".format(1*confidence))
                    confidence > 0.85 -> getString(R.string.result_think_hero_found, hero, "%.2f".format(1*confidence))
